    ...
    if (options.download) {
      ...
      try {
        ...
        if (options.inject) {
          ...
          writeFileSync(resolve(outputDir, options.stylePath), `
@font-face {
  font-family: 'Inter';
  font-style: normal;
  font-weight: 400;
...
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: url('../fonts/Ubuntu-400-8.woff2') format('woff2');
}
@font-face {
  font-family: 'Ubuntu';
  font-style: normal;
  font-weight: 400;
  font-display: swap;
  src: url('../fonts/Ubuntu-400-9.woff2') format('woff2');
}
@font-face {
  font-family: 'Ubuntu';
  font-style: normal;
  font-weight: 400;
  font-display: swap;
  src: url('../fonts/Ubuntu-400-10.woff2') format('woff2');
}
@font-face {
  font-family: 'Ubuntu';
  font-style: normal;
  font-weight: 400;
  font-display: swap;
  src: url('../fonts/Ubuntu-400-11.woff2') format('woff2');
}
@font-face {
  font-family: 'Ubuntu';
  font-style: normal;
  font-weight: 400;
  font-display: swap;
  src: url('../fonts/Ubuntu-400-12.woff2') format('woff2');
}
/* latin */
@font-face {
  font-family: 'Ubuntu';
  ...
  font-weight: 400;
  font-display: swap;
  src: url('../fonts/Ubuntu-400-13.woff2') format('woff2');
}
`, 'utf-8')
          console.log(content)
